...
/**
 * The PSO planning algorithm Main Test.
 *
 * @author Meysam Farsi , meysam.hit@gmail.com
 * @date Feb 23, 2018
 */
public class PSOPlanningMain extends WorkflowSimBasicExample1 {
    ...
    protected static List<CondorVM> createVM(int userId, int vms) {
        ...
        int mipsList[] = {4400,8800,17600,35200,57200,1144200};
        //create VMs
        CondorVM[] vm = new CondorVM[vms];
        Random bwRandom = new Random(System.currentTimeMillis());
        for (int i = 0; i < vms; i++) {
            double ratio = bwRandom.nextDouble();
            vm[i] = new CondorVM(i, userId, mipsList[i], pesNumber, ram, (long) (bw ), size, vmm, new CloudletSchedulerSpaceShared());
            list.add(vm[i]);
        }
        return list;
    }
    ...
    public static void main(String[] args) {
        ...
        try {
             ...
             */
            int vmNum = 6;//number of vms;
            /**
             * Should change this based on real physical path
             */
            String daxPath = "D:\\Research\\University\\Thesis\\tools\\WorkflowSim-1.0-master\\config\\dax\\Montage_1000.xml";
