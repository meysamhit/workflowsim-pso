...
public class WorkflowSimBasicExample1 {
    ...
    public static void main(String[] args) {
        try {
             ...
             */
            String daxPath = "D:\\Research\\University\\Thesis\\tools\\WorkflowSim-1.0-master\\config\\dax\\CyberShake_30.xml";
    ...
    protected static void printJobList(List<Job> list) {
        ...
        try {
            ...
            int jobSize =  list.size();
            
            double start= list.get(0).getExecStartTime();
            double end = list.get(jobSize-1).getFinishTime();
